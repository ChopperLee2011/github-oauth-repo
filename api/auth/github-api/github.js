...
(function() {
  ...
  var Github = function(options) {
    ...
    Github.Issue = function(options) {
      if ( options.issueNum) {
        var path = "/repos/" + options.user + "/" + options.repo + "/issues/"+options.issueNum;
      }
      else{
        var path = "/repos/" + options.user + "/" + options.repo + "/issues?state=all";
      }
    ...
    this.getIssue = function(user, repo, issueNum){
      return new Github.Issue({user: user, repo: repo, issueNum: issueNum});
    };
